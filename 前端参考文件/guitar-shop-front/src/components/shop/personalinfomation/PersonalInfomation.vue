        ...
        <div style="margin-top:25px;margin-left:80px;">
            <el-row :gutter="10">
                <el-col :span="2">
                    ...
                    <div style="margin-top:5px;margin-left:6px;"><span>潘某某</span></div>
                    ...
                    <div style="margin-top:5px;margin-left:1px;">
                        <el-button type="text" style="font-size:15px;color:#4D4D4D;" @click="passwordClick()">修改密码<span
                                        ...
                                        <el-col>
                                            <el-timeline>
                                                <el-timeline-item timestamp="项目一" placement="top">
                                                    <el-card>
                                                        <div><span><span
                                                                    style="font-family:'宋体';font-size:15px;"><strong>项目名称</strong></span><span
                                                                    style="font-family:'宋体';font-size:12px;margin-left:20px;"><strong>管理单位</strong></span></span>
                                                        </div>
                                                        <div>
                                ...
                                <el-row :gutter="12" style="margin-top:20px;">
                                    ...
                                    <el-col :span="5">
                                        <el-form-item prop="account">
                                            <el-input type="text" v-model="personalForm.account" placeholder="请输入您的账号">
                                            </el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                <el-row :gutter="12" style="margin-top:1px;">
                                    ...
                                    <el-col :span="5">
                                        <el-form-item prop="phone_num">
                                            <el-input type="text" v-model="personalForm.phone_num" placeholder="绑定的手机号">
                                            </el-input>
                                        </el-form-item>
                                    </el-col>
                                </el-row>
                                ...
                                <el-row :gutter="12" style="margin-top:1px;">
                                    ...
                                    <el-col :span="5">
                                        <el-form-item prop="verification">
                                            <el-input type="text" v-model="personalForm.verification" placeholder="验证码">
                                            </el-input>
                                        </el-form-item>
                                    </el-col>
                                    <el-col :span="2">
                                        <el-button type="primary" plain round size="medium" @click="sendMsg()"
...
import yu from '../../../assets/img/bj01.jpg'
